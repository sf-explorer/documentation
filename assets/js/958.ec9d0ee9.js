...
var error_GraphQLError = __webpack_require__(65496);
...
function LoneSchemaDefinitionRule(context) {
  ...
  return {
    SchemaDefinition(node) {
      if (alreadyDefined) {
        context.reportError(
          new error_GraphQLError/* GraphQLError */.eO(
      ...
      if (schemaDefinitionsCount > 0) {
        context.reportError(
          new error_GraphQLError/* GraphQLError */.eO('Must provide only one schema definition.', {
            nodes: node,
          }),
        );
      }
...
function UniqueTypeNamesRule(context) {
  ...
  function checkTypeName(node) {
    ...
    if (knownTypeNames[typeName]) {
      context.reportError(
        new error_GraphQLError/* GraphQLError */.eO(`There can be only one type named "${typeName}".`, {
...
function UniqueEnumValueNamesRule(context) {
  ...
  function checkValueUniqueness(node) {
    ...
    for (const valueDef of valueNodes) {
      ...
      if ((0,definition/* isEnumType */.oF)(existingType) && existingType.getValue(valueName)) {
        context.reportError(
          new error_GraphQLError/* GraphQLError */.eO(
...
function hasField(type, fieldName) {
  if ((0,definition/* isObjectType */.YQ)(type) || (0,definition/* isInterfaceType */.kD)(type) || (0,definition/* isInputObjectType */.qK)(type)) {
...
// EXTERNAL MODULE: ./node_modules/graphql/jsutils/didYouMean.mjs
var didYouMean = __webpack_require__(8100);
// EXTERNAL MODULE: ./node_modules/graphql/jsutils/suggestionList.mjs
var suggestionList = __webpack_require__(72239);
...
function isExecutableDefinitionNode(node) {
  return (
    node.kind === kinds/* Kind */.b.OPERATION_DEFINITION ||
    node.kind === kinds/* Kind */.b.FRAGMENT_DEFINITION
  );
}
...
function isTypeSystemDefinitionNode(node) {
  return (
    node.kind === kinds/* Kind */.b.SCHEMA_DEFINITION ||
    isTypeDefinitionNode(node) ||
    node.kind === kinds/* Kind */.b.DIRECTIVE_DEFINITION
  );
}
function isTypeDefinitionNode(node) {
  return (
    node.kind === kinds/* Kind */.b.SCALAR_TYPE_DEFINITION ||
    node.kind === kinds/* Kind */.b.OBJECT_TYPE_DEFINITION ||
    node.kind === kinds/* Kind */.b.INTERFACE_TYPE_DEFINITION ||
    node.kind === kinds/* Kind */.b.UNION_TYPE_DEFINITION ||
    node.kind === kinds/* Kind */.b.ENUM_TYPE_DEFINITION ||
    node.kind === kinds/* Kind */.b.INPUT_OBJECT_TYPE_DEFINITION
  );
}
function isTypeSystemExtensionNode(node) {
  return node.kind === kinds/* Kind */.b.SCHEMA_EXTENSION || isTypeExtensionNode(node);
}
function isTypeExtensionNode(node) {
  return (
    node.kind === kinds/* Kind */.b.SCALAR_TYPE_EXTENSION ||
    node.kind === kinds/* Kind */.b.OBJECT_TYPE_EXTENSION ||
    node.kind === kinds/* Kind */.b.INTERFACE_TYPE_EXTENSION ||
    node.kind === kinds/* Kind */.b.UNION_TYPE_EXTENSION ||
    node.kind === kinds/* Kind */.b.ENUM_TYPE_EXTENSION ||
    node.kind === kinds/* Kind */.b.INPUT_OBJECT_TYPE_EXTENSION
  );
}

// EXTERNAL MODULE: ./node_modules/graphql/type/introspection.mjs
var introspection = __webpack_require__(9488);
// EXTERNAL MODULE: ./node_modules/graphql/type/scalars.mjs
var scalars = __webpack_require__(13770);
  ...
  return {
    NamedType(node, _1, parent, _2, ancestors) {
      ...
      if (!existingTypesMap[typeName] && !definedTypes[typeName]) {
        ...
        const suggestedTypes = (0,suggestionList/* suggestionList */.x)(
          typeName,
          isSDL ? standardTypeNames.concat(typeNames) : typeNames,
        );
        context.reportError(
          new error_GraphQLError/* GraphQLError */.eO(
            `Unknown type "${typeName}".` + (0,didYouMean/* didYouMean */.a)(suggestedTypes),
            {
              nodes: node,
            },
          ),
...
const standardTypeNames = [...scalars/* specifiedScalarTypes */.YC, ...introspection/* introspectionTypes */.V4].map(
  (type) => type.name,
);
...
var jsutils_inspect = __webpack_require__(80129);
...
function KnownDirectivesRule(context) {
  ...
  const definedDirectives = schema
    ...
    : directives/* specifiedDirectives */.rc;
  ...
  for (const def of astDefinitions) {
    if (def.kind === kinds/* Kind */.b.DIRECTIVE_DEFINITION) {
  ...
  return {
    Directive(node, _key, _parent, _path, ancestors) {
      ...
      if (!locations) {
        context.reportError(
          new error_GraphQLError/* GraphQLError */.eO(`Unknown directive "@${name}".`, {
            nodes: node,
          }),
        );
        return;
...
function getDirectiveLocationForASTPath(ancestors) {
  ...
  'kind' in appliedTo || (0,invariant/* invariant */.V)(false);

  switch (appliedTo.kind) {
    case kinds/* Kind */.b.OPERATION_DEFINITION:
      return getDirectiveLocationForOperation(appliedTo.operation);

    case kinds/* Kind */.b.FIELD:
      return directiveLocation/* DirectiveLocation */.H.FIELD;

    case kinds/* Kind */.b.FRAGMENT_SPREAD:
      return directiveLocation/* DirectiveLocation */.H.FRAGMENT_SPREAD;

    case kinds/* Kind */.b.INLINE_FRAGMENT:
      return directiveLocation/* DirectiveLocation */.H.INLINE_FRAGMENT;

    case kinds/* Kind */.b.FRAGMENT_DEFINITION:
      return directiveLocation/* DirectiveLocation */.H.FRAGMENT_DEFINITION;

    case kinds/* Kind */.b.VARIABLE_DEFINITION:
      return directiveLocation/* DirectiveLocation */.H.VARIABLE_DEFINITION;

    case kinds/* Kind */.b.SCHEMA_DEFINITION:
    case kinds/* Kind */.b.SCHEMA_EXTENSION:
      return directiveLocation/* DirectiveLocation */.H.SCHEMA;

    case kinds/* Kind */.b.SCALAR_TYPE_DEFINITION:
    case kinds/* Kind */.b.SCALAR_TYPE_EXTENSION:
      return directiveLocation/* DirectiveLocation */.H.SCALAR;

    case kinds/* Kind */.b.OBJECT_TYPE_DEFINITION:
    case kinds/* Kind */.b.OBJECT_TYPE_EXTENSION:
      return directiveLocation/* DirectiveLocation */.H.OBJECT;

    case kinds/* Kind */.b.FIELD_DEFINITION:
      return directiveLocation/* DirectiveLocation */.H.FIELD_DEFINITION;

    case kinds/* Kind */.b.INTERFACE_TYPE_DEFINITION:
    case kinds/* Kind */.b.INTERFACE_TYPE_EXTENSION:
      return directiveLocation/* DirectiveLocation */.H.INTERFACE;

    case kinds/* Kind */.b.UNION_TYPE_DEFINITION:
    case kinds/* Kind */.b.UNION_TYPE_EXTENSION:
      return directiveLocation/* DirectiveLocation */.H.UNION;

    case kinds/* Kind */.b.ENUM_TYPE_DEFINITION:
    case kinds/* Kind */.b.ENUM_TYPE_EXTENSION:
      return directiveLocation/* DirectiveLocation */.H.ENUM;

    case kinds/* Kind */.b.ENUM_VALUE_DEFINITION:
      return directiveLocation/* DirectiveLocation */.H.ENUM_VALUE;

    case kinds/* Kind */.b.INPUT_OBJECT_TYPE_DEFINITION:
    case kinds/* Kind */.b.INPUT_OBJECT_TYPE_EXTENSION:
      return directiveLocation/* DirectiveLocation */.H.INPUT_OBJECT;

    case kinds/* Kind */.b.INPUT_VALUE_DEFINITION: {
      const parentNode = ancestors[ancestors.length - 3];
      'kind' in parentNode || (0,invariant/* invariant */.V)(false);
      return parentNode.kind === kinds/* Kind */.b.INPUT_OBJECT_TYPE_DEFINITION
        ? directiveLocation/* DirectiveLocation */.H.INPUT_FIELD_DEFINITION
        : directiveLocation/* DirectiveLocation */.H.ARGUMENT_DEFINITION;
    }
    ...
    default:
       false || (0,invariant/* invariant */.V)(false, 'Unexpected kind: ' + (0,jsutils_inspect/* inspect */.N)(appliedTo.kind));
  }
}

function getDirectiveLocationForOperation(operation) {
  switch (operation) {
    case ast/* OperationTypeNode */.cE.QUERY:
      return directiveLocation/* DirectiveLocation */.H.QUERY;

    case ast/* OperationTypeNode */.cE.MUTATION:
      return directiveLocation/* DirectiveLocation */.H.MUTATION;

    case ast/* OperationTypeNode */.cE.SUBSCRIPTION:
      return directiveLocation/* DirectiveLocation */.H.SUBSCRIPTION;
  }
}
...
function UniqueDirectivesPerLocationRule(context) {
  ...
  return {
    ...
    enter(node) {
      ...
      if (
        node.kind === kinds/* Kind */.b.SCHEMA_DEFINITION ||
        node.kind === kinds/* Kind */.b.SCHEMA_EXTENSION
      ) {
  ...
  function checkExtension(node) {
    ...
    if (expectedKind) {
      if (expectedKind !== node.kind) {
        ...
        context.reportError(
          new error_GraphQLError/* GraphQLError */.eO(`Cannot extend non-${kindStr} type "${typeName}".`, {
      ...
      const suggestedTypes = (0,suggestionList/* suggestionList */.x)(typeName, allTypeNames);
      context.reportError(
        new error_GraphQLError/* GraphQLError */.eO(
          `Cannot extend type "${typeName}" because it is not defined.` +
            (0,didYouMean/* didYouMean */.a)(suggestedTypes),
          {
            nodes: node.name,
          },
        ),
...
const defKindToExtKind = {
  [kinds/* Kind */.b.SCALAR_TYPE_DEFINITION]: kinds/* Kind */.b.SCALAR_TYPE_EXTENSION,
  [kinds/* Kind */.b.OBJECT_TYPE_DEFINITION]: kinds/* Kind */.b.OBJECT_TYPE_EXTENSION,
  [kinds/* Kind */.b.INTERFACE_TYPE_DEFINITION]: kinds/* Kind */.b.INTERFACE_TYPE_EXTENSION,
  [kinds/* Kind */.b.UNION_TYPE_DEFINITION]: kinds/* Kind */.b.UNION_TYPE_EXTENSION,
  [kinds/* Kind */.b.ENUM_TYPE_DEFINITION]: kinds/* Kind */.b.ENUM_TYPE_EXTENSION,
  [kinds/* Kind */.b.INPUT_OBJECT_TYPE_DEFINITION]: kinds/* Kind */.b.INPUT_OBJECT_TYPE_EXTENSION,
};

function typeToExtKind(type) {
  if ((0,definition/* isScalarType */.lg)(type)) {
    return kinds/* Kind */.b.SCALAR_TYPE_EXTENSION;
  }

  if ((0,definition/* isObjectType */.YQ)(type)) {
    return kinds/* Kind */.b.OBJECT_TYPE_EXTENSION;
  }

  if ((0,definition/* isInterfaceType */.kD)(type)) {
    return kinds/* Kind */.b.INTERFACE_TYPE_EXTENSION;
  }

  if ((0,definition/* isUnionType */.CK)(type)) {
    return kinds/* Kind */.b.UNION_TYPE_EXTENSION;
  }

  if ((0,definition/* isEnumType */.oF)(type)) {
    return kinds/* Kind */.b.ENUM_TYPE_EXTENSION;
  }

  if ((0,definition/* isInputObjectType */.qK)(type)) {
    return kinds/* Kind */.b.INPUT_OBJECT_TYPE_EXTENSION;
  }
  /* c8 ignore next 3 */
  // Not reachable. All possible types have been considered

   false || (0,invariant/* invariant */.V)(false, 'Unexpected type: ' + (0,jsutils_inspect/* inspect */.N)(type));
}
...
function extensionKindToTypeName(kind) {
  switch (kind) {
    ...
    default:
       false || (0,invariant/* invariant */.V)(false, 'Unexpected kind: ' + (0,jsutils_inspect/* inspect */.N)(kind));
  }
}

;// CONCATENATED MODULE: ./node_modules/graphql/jsutils/groupBy.mjs
/**
  ...
  return {
    ObjectValue: {
      ...
      leave() {
        ...
        prevKnownNames || (0,invariant/* invariant */.V)(false);
    ...
    Document(node) {
      for (const definition of node.definitions) {
        if (!isExecutableDefinitionNode(definition)) {
          const defName =
            definition.kind === kinds/* Kind */.b.SCHEMA_DEFINITION ||
            definition.kind === kinds/* Kind */.b.SCHEMA_EXTENSION
              ? 'schema'
              : '"' + definition.name.value + '"';
          context.reportError(
            new error_GraphQLError/* GraphQLError */.eO(`The ${defName} definition is not executable.`, {
              nodes: definition,
            }),
          );
        }
...
// EXTERNAL MODULE: ./node_modules/graphql/jsutils/naturalCompare.mjs
var naturalCompare = __webpack_require__(49779);
    ...
    Field(node) {
      ...
      if (type) {
        ...
        if (!fieldDef) {
          ...
          let suggestion = (0,didYouMean/* didYouMean */.a)(
            'to use an inline fragment on',
            getSuggestedTypeNames(schema, type, fieldName),
          ); // If there are no suggested types, then perhaps this was a typo?

          if (suggestion === '') {
            suggestion = (0,didYouMean/* didYouMean */.a)(getSuggestedFieldNames(type, fieldName));
...
function getSuggestedTypeNames(schema, type, fieldName) {
  if (!(0,definition/* isAbstractType */.Lc)(type)) {
  ...
  return [...suggestedTypes]
    .sort((typeA, typeB) => {
      ...
      if ((0,definition/* isInterfaceType */.kD)(typeA) && schema.isSubType(typeA, typeB)) {
        return -1;
      }

      if ((0,definition/* isInterfaceType */.kD)(typeB) && schema.isSubType(typeB, typeA)) {
        return 1;
      }

      return (0,naturalCompare/* naturalCompare */.p)(typeA.name, typeB.name);
    })
    .map((x) => x.name);
}
/**
...
function getSuggestedFieldNames(type, fieldName) {
  if ((0,definition/* isObjectType */.YQ)(type) || (0,definition/* isInterfaceType */.kD)(type)) {
    const possibleFieldNames = Object.keys(type.getFields());
    return (0,suggestionList/* suggestionList */.x)(fieldName, possibleFieldNames);
...
var printer = __webpack_require__(33119);
// EXTERNAL MODULE: ./node_modules/graphql/utilities/typeFromAST.mjs
var utilities_typeFromAST = __webpack_require__(39581);
...
function FragmentsOnCompositeTypesRule(context) {
  return {
    InlineFragment(node) {
      ...
      if (typeCondition) {
        const type = (0,utilities_typeFromAST/* typeFromAST */.v)(context.getSchema(), typeCondition);

        if (type && !(0,definition/* isCompositeType */.ML)(type)) {
          const typeStr = (0,printer/* print */.y)(typeCondition);
          context.reportError(
            new error_GraphQLError/* GraphQLError */.eO(
    ...
    FragmentDefinition(node) {
      const type = (0,utilities_typeFromAST/* typeFromAST */.v)(context.getSchema(), node.typeCondition);

      if (type && !(0,definition/* isCompositeType */.ML)(type)) {
        const typeStr = (0,printer/* print */.y)(node.typeCondition);
        context.reportError(
          new error_GraphQLError/* GraphQLError */.eO(
  ...
  return {
    ...
    Argument(argNode) {
      ...
      if (!argDef && fieldDef && parentType) {
        ...
        const suggestions = (0,suggestionList/* suggestionList */.x)(argName, knownArgsNames);
        context.reportError(
          new error_GraphQLError/* GraphQLError */.eO(
            `Unknown argument "${argName}" on field "${parentType.name}.${fieldDef.name}".` +
              (0,didYouMean/* didYouMean */.a)(suggestions),
            {
              nodes: argNode,
            },
          ),
      ...
      if (directiveNode.arguments && knownArgs) {
        for (const argNode of directiveNode.arguments) {
          ...
          if (!knownArgs.includes(argName)) {
            const suggestions = (0,suggestionList/* suggestionList */.x)(argName, knownArgs);
            context.reportError(
              new error_GraphQLError/* GraphQLError */.eO(
...
function KnownFragmentNamesRule(context) {
  return {
    FragmentSpread(node) {
      ...
      if (!fragment) {
        context.reportError(
          new error_GraphQLError/* GraphQLError */.eO(`Unknown fragment "${fragmentName}".`, {
            nodes: node.name,
          }),
        );
      }
  ...
  return {
    Document(node) {
      operationCount = node.definitions.filter(
        (definition) => definition.kind === kinds/* Kind */.b.OPERATION_DEFINITION,
      ).length;
    },
      ...
      leave() {
        ...
        for (const fragmentDef of fragmentDefs) {
          ...
          if (fragmentNameUsed[fragName] !== true) {
            context.reportError(
              new error_GraphQLError/* GraphQLError */.eO(`Fragment "${fragName}" is never used.`, {
                nodes: fragmentDef,
              }),
            );
          }
...
;// CONCATENATED MODULE: ./node_modules/graphql/utilities/sortValueNode.mjs
...
function sortValueNode(valueNode) {
  switch (valueNode.kind) {
    case kinds/* Kind */.b.OBJECT:
      return { ...valueNode, fields: sortFields(valueNode.fields) };

    case kinds/* Kind */.b.LIST:
      return { ...valueNode, values: valueNode.values.map(sortValueNode) };

    case kinds/* Kind */.b.INT:
    case kinds/* Kind */.b.FLOAT:
    case kinds/* Kind */.b.STRING:
    case kinds/* Kind */.b.BOOLEAN:
    case kinds/* Kind */.b.NULL:
    case kinds/* Kind */.b.ENUM:
    case kinds/* Kind */.b.VARIABLE:
      return valueNode;
  }
}
...
function sortFields(fields) {
  return fields
    ...
    .sort((fieldA, fieldB) =>
      (0,naturalCompare/* naturalCompare */.p)(fieldA.name.value, fieldB.name.value),
    );
}
...
function findConflict(
  ...
  const areMutuallyExclusive =
    ...
    (parentType1 !== parentType2 &&
      (0,definition/* isObjectType */.YQ)(parentType1) &&
      (0,definition/* isObjectType */.YQ)(parentType2));
  ...
  if (type1 && type2 && doTypesConflict(type1, type2)) {
    return [
      [
        responseName,
        `they return conflicting types "${(0,jsutils_inspect/* inspect */.N)(type1)}" and "${(0,jsutils_inspect/* inspect */.N)(
          type2,
        )}"`,
      ],
      [node1],
  ...
  if (selectionSet1 && selectionSet2) {
    const conflicts = findConflictsBetweenSubSelectionSets(
      ...
      comparedFragmentPairs,
      areMutuallyExclusive,
      (0,definition/* getNamedType */.MR)(type1),
      selectionSet1,
      (0,definition/* getNamedType */.MR)(type2),
      selectionSet2,
    );
...
function stringifyValue(value) {
  return (0,printer/* print */.y)(sortValueNode(value));
} // Two types conflict if both types could not apply to a value simultaneously.
// Composite types are ignored as their individual field types will be compared
// later recursively. However List and Non-Null types must match.

function doTypesConflict(type1, type2) {
  if ((0,definition/* isListType */.Fs)(type1)) {
    return (0,definition/* isListType */.Fs)(type2)
      ? doTypesConflict(type1.ofType, type2.ofType)
      : true;
  }

  if ((0,definition/* isListType */.Fs)(type2)) {
    return true;
  }

  if ((0,definition/* isNonNullType */.bd)(type1)) {
    return (0,definition/* isNonNullType */.bd)(type2)
      ? doTypesConflict(type1.ofType, type2.ofType)
      : true;
  }

  if ((0,definition/* isNonNullType */.bd)(type2)) {
    return true;
  }

  if ((0,definition/* isLeafType */.zf)(type1) || (0,definition/* isLeafType */.zf)(type2)) {
    return type1 !== type2;
  }
...
function getReferencedFieldsAndFragmentNames(
  ...
  const fragmentType = (0,utilities_typeFromAST/* typeFromAST */.v)(context.getSchema(), fragment.typeCondition);
  ...
  for (const selection of selectionSet.selections) {
    switch (selection.kind) {
      case kinds/* Kind */.b.FIELD: {
        ...
        if ((0,definition/* isObjectType */.YQ)(parentType) || (0,definition/* isInterfaceType */.kD)(parentType)) {
      ...
      case kinds/* Kind */.b.INLINE_FRAGMENT: {
        ...
        const inlineFragmentType = typeCondition
          ? (0,utilities_typeFromAST/* typeFromAST */.v)(context.getSchema(), typeCondition)
          : parentType;
...
var typeComparators = __webpack_require__(61578);
...
function PossibleFragmentSpreadsRule(context) {
  return {
    InlineFragment(node) {
      ...
      if (
        (0,definition/* isCompositeType */.ML)(fragType) &&
        (0,definition/* isCompositeType */.ML)(parentType) &&
        !(0,typeComparators/* doTypesOverlap */.uI)(context.getSchema(), fragType, parentType)
      ) {
        const parentTypeStr = (0,jsutils_inspect/* inspect */.N)(parentType);
        const fragTypeStr = (0,jsutils_inspect/* inspect */.N)(fragType);
        context.reportError(
          new error_GraphQLError/* GraphQLError */.eO(
...
function getFragmentType(context, name) {
  ...
  if (frag) {
    const type = (0,utilities_typeFromAST/* typeFromAST */.v)(context.getSchema(), frag.typeCondition);

    if ((0,definition/* isCompositeType */.ML)(type)) {
      return type;
    }
  }
}
...
var keyMap = __webpack_require__(62242);
    ...
    Field: {
      ...
      leave(fieldNode) {
        ...
        for (const argDef of fieldDef.args) {
          if (!providedArgs.has(argDef.name) && (0,definition/* isRequiredArgument */.xP)(argDef)) {
            const argTypeStr = (0,jsutils_inspect/* inspect */.N)(argDef.type);
            context.reportError(
              new error_GraphQLError/* GraphQLError */.eO(
...
function ProvidedRequiredArgumentsOnDirectivesRule(context) {
  ...
  for (const directive of definedDirectives) {
    requiredArgsMap[directive.name] = (0,keyMap/* keyMap */.K)(
      directive.args.filter(definition/* isRequiredArgument */.xP),
      (arg) => arg.name,
    );
  }
    ...
    if (def.kind === kinds/* Kind */.b.DIRECTIVE_DEFINITION) {
      ...
      const argNodes =
        (_def$arguments = def.arguments) !== null && _def$arguments !== void 0
          ? _def$arguments
          : [];
      requiredArgsMap[def.name.value] = (0,keyMap/* keyMap */.K)(
        ...
        if (requiredArgs) {
          ...
          for (const [argName, argDef] of Object.entries(requiredArgs)) {
            if (!argNodeMap.has(argName)) {
              const argType = (0,definition/* isType */.Xj)(argDef.type)
                ? (0,jsutils_inspect/* inspect */.N)(argDef.type)
                : (0,printer/* print */.y)(argDef.type);
              context.reportError(
                new error_GraphQLError/* GraphQLError */.eO(
...
function isRequiredArgumentNode(arg) {
  return arg.type.kind === kinds/* Kind */.b.NON_NULL_TYPE && arg.defaultValue == null;
}
...
function ScalarLeafsRule(context) {
  return {
    Field(node) {
      ...
      if (type) {
        if ((0,definition/* isLeafType */.zf)((0,definition/* getNamedType */.MR)(type))) {
          if (selectionSet) {
            const fieldName = node.name.value;
            const typeStr = (0,jsutils_inspect/* inspect */.N)(type);
            context.reportError(
              new error_GraphQLError/* GraphQLError */.eO(
...
var utilities_valueFromAST = __webpack_require__(70726);
...
function getArgumentValues(def, node, variableValues) {
  ...
  const argumentNodes =
    (_node$arguments = node.arguments) !== null && _node$arguments !== void 0
      ? _node$arguments
      : [];
  const argNodeMap = (0,keyMap/* keyMap */.K)(argumentNodes, (arg) => arg.name.value);
  ...
  for (const argDef of def.args) {
    ...
    if (!argumentNode) {
      ...
      } else if ((0,definition/* isNonNullType */.bd)(argType)) {
        throw new error_GraphQLError/* GraphQLError */.eO(
          `Argument "${name}" of required type "${(0,jsutils_inspect/* inspect */.N)(argType)}" ` +
            'was not provided.',
          {
            nodes: node,
          },
    ...
    let isNull = valueNode.kind === kinds/* Kind */.b.NULL;

    if (valueNode.kind === kinds/* Kind */.b.VARIABLE) {
    ...
    if (isNull && (0,definition/* isNonNullType */.bd)(argType)) {
      throw new error_GraphQLError/* GraphQLError */.eO(
        `Argument "${name}" of non-null type "${(0,jsutils_inspect/* inspect */.N)(argType)}" ` +
          'must not be null.',
        {
          nodes: valueNode,
        },
    ...
    const coercedValue = (0,utilities_valueFromAST/* valueFromAST */.i)(valueNode, argType, variableValues);
    ...
    if (coercedValue === undefined) {
      ...
      throw new error_GraphQLError/* GraphQLError */.eO(
        `Argument "${name}" has invalid value ${(0,printer/* print */.y)(valueNode)}.`,
        {
          nodes: valueNode,
        },
      );
...
;// CONCATENATED MODULE: ./node_modules/graphql/execution/collectFields.mjs
...
function shouldIncludeNode(variableValues, node) {
  const skip = getDirectiveValues(directives/* GraphQLSkipDirective */.MQ, node, variableValues);
  ...
  const include = getDirectiveValues(
    directives/* GraphQLIncludeDirective */.HQ,
    node,
    variableValues,
  );
...
function doesFragmentConditionMatch(schema, fragment, type) {
  ...
  const conditionalType = (0,utilities_typeFromAST/* typeFromAST */.v)(schema, typeConditionNode);

  if (conditionalType === type) {
    return true;
  }

  if ((0,definition/* isAbstractType */.Lc)(conditionalType)) {
      ...
      if (node.operation === 'subscription') {
        ...
        if (subscriptionType) {
          ...
          for (const definition of document.definitions) {
            if (definition.kind === kinds/* Kind */.b.FRAGMENT_DEFINITION) {
...
;// CONCATENATED MODULE: ./node_modules/graphql/validation/rules/UniqueArgumentDefinitionNamesRule.mjs
...
function ValuesOfCorrectTypeRule(context) {
  return {
    ListValue(node) {
      ...
      const type = (0,definition/* getNullableType */.yl)(context.getParentInputType());

      if (!(0,definition/* isListType */.Fs)(type)) {
    ...
    ObjectValue(node) {
      const type = (0,definition/* getNamedType */.MR)(context.getInputType());
      ...
      const fieldNodeMap = (0,keyMap/* keyMap */.K)(node.fields, (field) => field.name.value);

      for (const fieldDef of Object.values(type.getFields())) {
        const fieldNode = fieldNodeMap[fieldDef.name];

        if (!fieldNode && (0,definition/* isRequiredInputField */.YX)(fieldDef)) {
          const typeStr = (0,jsutils_inspect/* inspect */.N)(fieldDef.type);
          context.reportError(
            new error_GraphQLError/* GraphQLError */.eO(
    ...
    ObjectField(node) {
      const parentType = (0,definition/* getNamedType */.MR)(context.getParentInputType());
      const fieldType = context.getInputType();

      if (!fieldType && (0,definition/* isInputObjectType */.qK)(parentType)) {
        const suggestions = (0,suggestionList/* suggestionList */.x)(
          node.name.value,
    ...
    NullValue(node) {
      ...
      if ((0,definition/* isNonNullType */.bd)(type)) {
        context.reportError(
          new error_GraphQLError/* GraphQLError */.eO(
            `Expected value of type "${(0,jsutils_inspect/* inspect */.N)(type)}", found ${(0,printer/* print */.y)(node)}.`,
            {
              nodes: node,
            },
          ),
...
function isValidValueNode(context, node) {
  ...
  const type = (0,definition/* getNamedType */.MR)(locationType);

  if (!(0,definition/* isLeafType */.zf)(type)) {
    const typeStr = (0,jsutils_inspect/* inspect */.N)(locationType);
    context.reportError(
      new error_GraphQLError/* GraphQLError */.eO(
        `Expected value of type "${typeStr}", found ${(0,printer/* print */.y)(node)}.`,
        {
          nodes: node,
        },
      ),
  ...
  try {
    ...
    if (error instanceof error_GraphQLError/* GraphQLError */.eO) {
...
function VariablesAreInputTypesRule(context) {
  return {
    VariableDefinition(node) {
      const type = (0,utilities_typeFromAST/* typeFromAST */.v)(context.getSchema(), node.type);

      if (type !== undefined && !(0,definition/* isInputType */.dX)(type)) {
        const variableName = node.variable.name.value;
        const typeName = (0,printer/* print */.y)(node.type);
        context.reportError(
          new error_GraphQLError/* GraphQLError */.eO(
      ...
      leave(operation) {
        ...
        for (const { node, type, defaultValue } of usages) {
          ...
          if (varDef && type) {
            ...
            const schema = context.getSchema();
            const varType = (0,utilities_typeFromAST/* typeFromAST */.v)(schema, varDef.type);
            ...
            if (
              ...
              const varTypeStr = (0,jsutils_inspect/* inspect */.N)(varType);
              const typeStr = (0,jsutils_inspect/* inspect */.N)(type);
              context.reportError(
                new error_GraphQLError/* GraphQLError */.eO(
...
function allowedVariableUsage(
  ...
  if ((0,definition/* isNonNullType */.bd)(locationType) && !(0,definition/* isNonNullType */.bd)(varType)) {
    const hasNonNullVariableDefaultValue =
      varDefaultValue != null && varDefaultValue.kind !== kinds/* Kind */.b.NULL;
    ...
    return (0,typeComparators/* isTypeSubTypeOf */.sP)(schema, varType, nullableLocationType);
  }

  return (0,typeComparators/* isTypeSubTypeOf */.sP)(schema, varType, locationType);
}
  ...
  getFragment(name) {
    ...
    if (this._fragments) {
      ...
      for (const defNode of this.getDocument().definitions) {
        if (defNode.kind === kinds/* Kind */.b.FRAGMENT_DEFINITION) {
    ...
    if (!spreads) {
      ...
      while ((set = setsToVisit.pop())) {
        for (const selection of set.selections) {
          if (selection.kind === kinds/* Kind */.b.FRAGMENT_SPREAD) {
...
class ValidationContext_SDLValidationContext extends ASTValidationContext {
...
class ValidationContext extends ASTValidationContext {
  ...
  getVariableUsages(node) {
    ...
    if (!usages) {
      const newUsages = [];
      const typeInfo = new TypeInfo/* TypeInfo */.D(this._schema);
      (0,language_visitor/* visit */.YR)(
        node,
        (0,TypeInfo/* visitWithTypeInfo */.S)(typeInfo, {
...
function validate_validate(
  ...
  typeInfo = new TypeInfo/* TypeInfo */.D(schema),
) {
  ...
  const maxErrors =
    (_options$maxErrors =
      ...
      ? _options$maxErrors
      : 100;
  documentAST || (0,devAssert/* devAssert */.U)(false, 'Must provide document.'); // If the schema used for validation is invalid, throw an error.

  (0,validate/* assertValidSchema */.Y)(schema);
  ...
  const visitor = (0,language_visitor/* visitInParallel */.oP)(rules.map((rule) => rule(context))); // Visit the whole document with each instance of all provided rules.

  try {
    (0,language_visitor/* visit */.YR)(documentAST, (0,TypeInfo/* visitWithTypeInfo */.S)(typeInfo, visitor));
  } catch (e) {
    if (e !== abortObj) {
      throw e;
    }
  ...
  return {
    Field(node) {
      ...
      if (fieldDef && deprecationReason != null) {
        const parentType = context.getParentType();
        parentType != null || (0,invariant/* invariant */.V)(false);
        context.reportError(
          new error_GraphQLError/* GraphQLError */.eO(
    ...
    Argument(node) {
      ...
      if (argDef && deprecationReason != null) {
        ...
        if (directiveDef != null) {
          ...
          const parentType = context.getParentType();
          const fieldDef = context.getFieldDef();
          (parentType != null && fieldDef != null) || (0,invariant/* invariant */.V)(false);
          context.reportError(
            new error_GraphQLError/* GraphQLError */.eO(
    ...
    ObjectField(node) {
      const inputObjectDef = (0,definition/* getNamedType */.MR)(context.getParentInputType());
    ...
    EnumValue(node) {
      ...
      if (enumValueDef && deprecationReason != null) {
        const enumTypeDef = (0,definition/* getNamedType */.MR)(context.getInputType());
        enumTypeDef != null || (0,invariant/* invariant */.V)(false);
        context.reportError(
          new error_GraphQLError/* GraphQLError */.eO(
...
function getDiagnostics(query, schema = null, customRules, isRelayCompatMode, externalFragments) {
  ...
  if (externalFragments) {
    fragments = typeof externalFragments === "string" ? externalFragments : externalFragments.reduce((acc, node) => acc + (0,printer/* print */.y)(node) + "\n\n", "");
  }
  const enhancedQuery = fragments ? `${query}

${fragments}` : query;
  try {
    ast = (0,parser/* parse */.qg)(enhancedQuery);
  } catch (error) {
    if (error instanceof error_GraphQLError/* GraphQLError */.eO) {
...
function validateQuery(ast, schema = null, customRules, isRelayCompatMode) {
  ...
  const deprecationWarningAnnotations = validate_validate(schema, ast, [
