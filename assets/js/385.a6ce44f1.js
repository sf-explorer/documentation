...
function validateValue(type, valueAST) {
  ...
  if (type instanceof graphql__WEBPACK_IMPORTED_MODULE_5__/* .GraphQLNonNull */ .Gc) {
  ...
  if (type instanceof graphql__WEBPACK_IMPORTED_MODULE_5__/* .GraphQLList */ .KT) {
  ...
  if (type instanceof graphql__WEBPACK_IMPORTED_MODULE_5__/* .GraphQLInputObjectType */ .zP) {
    ...
    for (const fieldName of Object.keys(type.getFields())) {
      ...
      if (!providedFields[fieldName] && field.type instanceof graphql__WEBPACK_IMPORTED_MODULE_5__/* .GraphQLNonNull */ .Gc && !field.defaultValue) {
        fieldErrors.push([
          valueAST,
  ...
  if ((type instanceof graphql__WEBPACK_IMPORTED_MODULE_5__/* .GraphQLEnumType */ .Zb || type instanceof graphql__WEBPACK_IMPORTED_MODULE_5__/* .GraphQLScalarType */ .Ag) && (valueAST.kind !== "String" && valueAST.kind !== "Number" && valueAST.kind !== "Boolean" && valueAST.kind !== "Null" || isNullish(type.parseValue(valueAST.value)))) {
    return [[valueAST, `Expected value of type "${type}".`]];
  }
  return [];
}
