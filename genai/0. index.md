...
### 📊 Token Usage Report
Comprehensive analytics dashboard combining quality metrics, user feedback, and cost analysis (CO2 emissions and cost by topic/week) for data-driven AI optimization.
...
2. **Connect** to your Salesforce org using OAuth 2.0 authentication
...
- **[Token Usage Report](./token-usage-report)** - Comprehensive analytics combining quality, feedback, and cost (CO2 emissions and cost by topic/week)
